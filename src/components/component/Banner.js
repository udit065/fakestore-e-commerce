    ...
    return (
        <>
            <section className="flex h-[640px] xs:h-[120px]">
                ...
                <div className="container flex h-full w-full xs:h-[315px]">
                    <div className="flex flex-col justify-center ml-20 xs:ml-4" data-aos="flip-up">
                    ...
                    <div className="w-4/12 absolute top-40 xl:left-[52rem] lg:left-[28rem] xs:top:10 xs:left-56 " data-aos="fade-down"
