        ...
        <div className='flex justify-center flex-col items-center h-96 xs:h-[600px] bg-black text-white'>
            ...
            <div class="p-5 flex justify-center mt-4 xs:mt-6">
                <div class="xs:flex xs:flex-col xs:items-center">
                    ...
                    <input type="button" value="SUBSCRIBE" class="bg-orange-500 font-oswald w-40 xs:w-[250px] h-[42px] p-2 rounded-tr-full rounded-br-full xs:rounded-full text-white font-bold subpixel-antialiased xs:mt-2 cursor-pointer" />
                </div>
            </div>
        </div>
        // </div >
