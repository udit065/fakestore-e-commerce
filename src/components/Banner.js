    ...
    return (
        <>
            <section className="flex h-[640px] xs:h-[120px]">
                <div className="absolute inset-x-0 h-[642px] xs:h-[320px] lg:bg-cover bg-center xs:bg-center"
                ...
                <div className="container flex h-full w-full xs:h-[280px]">
                    ...
                    <div className="w-4/12 absolute top-40 left-[56rem] xs:top:10 xs:left-56" >
